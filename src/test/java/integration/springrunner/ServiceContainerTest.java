...
import springrunner.Service;
import springrunner.ServiceContainer;
import springrunner.StartCounterService;
...
@ContextConfiguration(locations="/integration/springrunner/ServiceContainerTest-beans.xml")
